  ...
  try {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <BackButton />
        <h1 className="text-3xl font-bold mb-8">Collaborative Playlists</h1>

        <div className="grid gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-4">Create a New Collaborative Playlist</h2>
            <p className="text-muted-foreground mb-4">
              Create a collaborative playlist that you can share with friends. Everyone can add their favorite tracks!
            </p>
            <CreateBlendForm />
          </div>

          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-4">Your Collaborative Playlists</h2>
